...
no padrão: DD/MM/YYYY HH:MM | SEÇÃO: DESCRIÇÃO EM MAIÚSCULO
"""
...
O relatório deve manter o padrão técnico da IA, com tópicos numerados, data, hora, tipo, operador, seção e descrição.
...
CORRETO:
5. 21/05/2026, 01:21:00 — HEMILY FERNANDES — PÚBLICA — CHEGADA AO LOCAL: O PRESTADOR INFORMA QUE CHEGOU AO LOCAL E LOCALIZOU O VEÍCULO COM AVARIAS, SEM VISUAL DO LOCATÁRIO, TRANCADO E COM ALARME ACIONADO.

ERRADO:
5. 21/05/2026, 01:21:00 — PRESTADOR — PÚBLICA — CHEGADA AO LOCAL: CHEGUEI AQUI E O CARRO ESTÁ TRANCADO.
...
[NÚMERO]. [DD/MM/YYYY], [HH:MM:SS] — [OPERADOR] — [TIPO] — [SEÇÃO]: [DESCRIÇÃO DO EVENTO EM MAIÚSCULO]
...
- [SEÇÃO] = etapa lógica do atendimento.
- [DESCRIÇÃO] = descrição formal, técnica e objetiva do evento.

### Exemplos:

1. 15/04/2026, 20:55:51 — OPERADOR — PÚBLICA — ABERTURA DO ATENDIMENTO: SOLICITAÇÃO DE ASSISTÊNCIA 24H PARA VEÍCULO COM RASTREAMENTO INOPERANTE.

2. 15/04/2026, 21:00:09 — HEMILY FERNANDES — PÚBLICA — DESLOCAMENTO: O PRESTADOR INFORMA DISPONIBILIDADE PARA ATENDIMENTO E INICIA DESLOCAMENTO AO LOCAL INDICADO.

3. 15/04/2026, 21:50:19 — HEMILY FERNANDES — PÚBLICA — DESENVOLVIMENTO: O PRESTADOR RELATA QUE O CONDUTOR IRIA DESLIGAR A CHAVE GERAL DO VEÍCULO.

4. 21/05/2026, 02:27:00 — HEMILY FERNANDES — INTERNA — DESENVOLVIMENTO / REGISTRO INTERNO: DADOS DO PRONTA REFERENTE AO VEÍCULO INFORMADO: NOME [NOME], CPF [CPF] E PLACA [PLACA].

5. 22/05/2026, 08:49:00 — CAROLINA CANDIDO GOMES — INTERNA — FINALIZAÇÃO / CONTROLE INTERNO: COBRANÇA KM INICIAL: [KM INICIAL] KM FINAL: [KM FINAL] TOTAL: [TOTAL].
